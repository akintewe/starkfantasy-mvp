        ...
        <footer className=" mt-auto bg-slate-900">
            <section className="flex justify-between items-center mx-10 mb-3 border-b-[1px]">
                <div className="flex justify-center items-center gap-4">
                    <div>
                        <img src="/icons/logo.png" alt="logo" className="w-[100px] h-[50px]" />
                    </div>
                ...
                <div className="text-[#ededed] mr-9">
                    ...
                    <ul className="flex gap-3 text-2xl ">
                        <li ><a href="/">  </a><span className="sr-only">GitHub</span></li>
                        <li><a href="/">  </a><span className="sr-only">Telegram</span></li>
                        <li><a href="/">  </a><span className="sr-only">Discord</span></li>
                    </ul>
                </div>
            </section>
